...
as.numeric(timeset),
as.numeric(profileList_pos[[2]][(profileList_pos[[7]][profileList_pos[[7]][,4]==profID,1]:profileList_pos[[7]][profileList_pos[[7]][,4]==profID,2]),6]),
as.numeric(profileList_pos[[2]][(profileList_pos[[7]][profileList_pos[[7]][,4]==profID,1]:profileList_pos[[7]][profileList_pos[[7]][,4]==profID,2]),2]),
...
if(logfile$parameters$ISnorm_medblank_pos=="TRUE"){
count_b<-0
if( logfile$parameters$ISnorm_usesubblank_pos=="TRUE" ){
...
count_nb<-0
if( logfile$parameters$ISnorm_usesubsam_pos=="TRUE" ){
...
as.numeric(corfac),
as.integer(sampleID),
as.numeric(profileList_pos[[2]][,2]),
...
int_norm_ISTD_pos[[5]] <<- list()
int_norm_ISTD_pos[[6]] <<- list()
int_norm_ISTD_pos[[7]] <<- list()
int_norm_ISTD_pos[[8]] <<- list()
...
timeset[,c(4,5)] <-.Call("_enviMass_fill_timeset",
as.numeric(timeset),
as.numeric(profileList_neg[[2]][(profileList_neg[[7]][profileList_neg[[7]][,4]==profID,1]:profileList_neg[[7]][profileList_neg[[7]][,4]==profID,2]),6]),
as.numeric(profileList_neg[[2]][(profileList_neg[[7]][profileList_neg[[7]][,4]==profID,1]:profileList_neg[[7]][profileList_neg[[7]][,4]==profID,2]),2]),
as.integer(length(timeset[,1])),
PACKAGE="enviMass"
)
timeset[timeset[,4]!=0,4]<-log10(timeset[timeset[,4]!=0,4])
...
peaks<-peaks[stillin,];
peaks<-peaks[sample(1:length(peaks[,1]),length(peaks[,1]), replace = FALSE),];
if(logfile$parameters$ISnorm_medblank_neg=="TRUE"){
count_b<-0
if( logfile$parameters$ISnorm_usesubblank_neg=="TRUE" ){
...
count_nb<-0
if( logfile$parameters$ISnorm_usesubsam_neg=="TRUE" ){
...
as.numeric(corfac),
as.integer(sampleID),
as.numeric(profileList_neg[[2]][,2]),
...
int_norm_ISTD_neg[[5]] <<- list()
int_norm_ISTD_neg[[6]] <<- list()
int_norm_ISTD_neg[[7]] <<- list()
int_norm_ISTD_neg[[8]] <<- list()
