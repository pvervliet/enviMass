        ...
        tabPanel("Settings",     
          ...
          tabsetPanel(
            ...
            tabPanel("Normalization",
				...
				div(style = widget_style3,
					tags$h4("Positive ionization:"),
					selectInput("ISnorm_include_pos", "Inlude mass recalibration for positive ion. mode files?", c("Yes"="TRUE","No"="FALSE"),"TRUE",multiple=FALSE), 
				...
				div(style = widget_style3,
					tags$h4("Negative ionization:"),
					selectInput("ISnorm_include_neg", "Inlude mass recalibration for positive ion. mode files?", c("Yes"="TRUE","No"="FALSE"),"TRUE",multiple=FALSE), 
