...
takeall<-TRUE
if(intstand[i,"restrict_adduct"]=="FALSE"){
if(intstand[i,"main_adduct"]=="FALSE"){
...
takeall<-TRUE
if(intstand[i,10]=="FALSE"){
if(intstand[i,6]=="FALSE"){
...
takeall<-TRUE
if(targets[i,11]=="FALSE"){
if(targets[i,7]=="FALSE"){
