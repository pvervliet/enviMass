...
(measurements[b,"components_files"] == "FALSE")
){
...
load(file = file.path(logfile[[1]],"peaklist",as.character(for_file)), envir = as.environment(".GlobalEnv"));
