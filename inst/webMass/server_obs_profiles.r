...
profpeaks2 <<- profpeaks2[profpeaks2[,"in_blind?"]==0,, drop = FALSE]
}
if(
...
if(isolate(input$filterProf_comparison) != "None"){
...
WVEKL7373U(	mean_intensities=profpeaks2[,"mean_int"],
...
observeEvent(input$timeprofile_dblclick, {
if(verbose){cat("\n in N")}
...
observeEvent(input$profile_EIC_click, {
cat("\n Zoom out part_1_a")
brush <- isolate(input$profile_EIC_brush)
if (is.null(brush)) {
cat("\n Zoom out part_1_b")
...
if(MSlist[["File_ID"]]!=as.character(use_file_ID)){
