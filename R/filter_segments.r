...
filter_segments<-function(
        homol,
        masslim = FALSE,
        RTlim = FALSE,
        massDlim = FALSE, # unused at the moment
        dmasslim = FALSE,
        dRTlim = FALSE
	){
	...
	if(masslim[1]!=FALSE){ # filter on mass
		plot_those[
